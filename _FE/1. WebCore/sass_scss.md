...
>   - [[sass_scss#Вложенность|Вложенность]]
>   - [[sass_scss#Родительский селектор &|Родительский селектор &]]
>   - [[sass_scss#Переменные $|Переменные $]]
>   - [[sass_scss#Импорт @import|Импорт @import]]
>   - [[sass_scss#Шаблоны %|Шаблоны %]]
>   - [[sass_scss#Миксины, mixin, примеси @|Миксины, mixin, примеси @]]
>   - [[sass_scss#Математика|Математика]]
>   - [[sass_scss#Комментарии|Комментарии]]
## Вложенность
